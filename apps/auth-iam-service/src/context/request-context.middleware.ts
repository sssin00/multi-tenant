...
import type { AuthIamRequest, AuthIamRequestContext } from "./request-context.js";
...
export class RequestContextMiddleware implements NestMiddleware {
  ...
  use(req: AuthIamRequest, res: Response, next: NextFunction) {
    ...
    const context: AuthIamRequestContext = {
      requestId,
      tenantId,
      userId
    };
