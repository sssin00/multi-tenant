...
import type { OutboxRequest, OutboxRequestContext } from "./request-context.js";
...
export class RequestContextMiddleware implements NestMiddleware {
  ...
  use(req: OutboxRequest, res: Response, next: NextFunction) {
    ...
    const context: OutboxRequestContext = {
      requestId,
      tenantId,
      userId
    };
  ...
  private readHeader(req: OutboxRequest, headerName: string): string | undefined {
